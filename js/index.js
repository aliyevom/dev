...
function switchDarkLightMode() {
    ...
    icon.addEventListener("mouseover", function() {
        icon.setAttribute("src", isDarkMode ? "sun-filled.svg" : "moon-full.svg");
    });

    icon.addEventListener("mouseout", function() {
        icon.setAttribute("src", isDarkMode ? "sun.svg" : "moon.svg");
    });
}

// Call the function to enable the dark/light mode switch
switchDarkLightMode();
